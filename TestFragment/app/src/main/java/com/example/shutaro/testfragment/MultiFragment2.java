...
public class MultiFragment2 extends Fragment {
     ...
     */
    @CheckResult
    public static MultiFragment2 createInstance(String name, int color) {

        // Fragmentを作成して返すメソッド
        MultiFragment2 fragment = new MultiFragment2();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_multi_fragment2, container, false);
    }
